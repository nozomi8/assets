  ...
  return (
    <div> 
      ...
      <a href="public/images/favorite-1.jpg">
        <img 
          src="public/images/favorite-1_th.jpg" 
          alt="Small black bird, black claws, long black slender beak, links to larger version of the image"
        />
      </a>
      <a href="public/images/favorite-2.jpg">
        <img 
          src="public/images/favorite-2_th.jpg" 
      ...
      <a href="public/images/favorite-3.jpg">
        <img
          src="public/images/favorite-3_th.jpg"
      ...
      <a href="public/images/favorite-4.jpg">
        <img
